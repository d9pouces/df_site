...
class ModelDetailComponent(ModelComponent):
    ...
    def __init__(
        self,
        model: Type[models.Model],
        template: str = "modersite/components/detail.html",
        inlines: List = None,
        fields=None,
        exclude=None,
        fieldsets=None,
...
class ModelDetailView(DetailView):
    ...
    model: Type[models.Model]
    component_template: str = "modersite/components/detail.html"
    inlines: List = None
    fields = None
    exclude = None
    fieldsets = None
    ...
    def get_template_names(self):
        ...
        return [
            f"modersite/{self.component.opts.app_label}/{self.component.opts.model_name}/detail.html",
            f"modersite/{self.component.opts.app_label}/detail.html",
